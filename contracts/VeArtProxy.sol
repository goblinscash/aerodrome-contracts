...
contract VeArtProxy is IVeArtProxy {
                ...
                string(
                    abi.encodePacked(
                        '{',
                            ...
                            '"description": "Goblins Cash is a next-generation AMM that combines the best of Curve, Convex and Uniswap, designed to serve as the Base central liquidity hub. Goblins NFTs vote on token emissions and receive bribes and fees generated by the protocol.",',
    ...
    /// @dev Calculates the number of digits before the "decimal point" in an NFT's veGOB balance.
    ...
    /// @dev Determines the number of lines in the SVG. NFTs with less than 10 veGOB balance have zero lines.
